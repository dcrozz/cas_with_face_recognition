...
var ConstantUtil = {
    ...
    toastDoSuccess : 'Success',
    toastDoFailure : 'Failed',
    toastGetSuccess : 'Fetch Data Success',
    toastGetFailure : 'Fetch Data Failed',

    toastPleaseInputNumber : 'Input Number',
    toastPleaseInputBz : 'Input Description',
    toastPleaseInputSolution : 'Input Solution',

    mLabelPosition : '        Position',
    mLabelEmployeeID : '    EmployeeID',

    toastPleaseInputPosition : 'Input Position',
    toastPleaseInputEmployeeID : 'Input Employee ID',
