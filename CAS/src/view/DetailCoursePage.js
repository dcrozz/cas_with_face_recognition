...
export default class DetailCoursePage extends BaseComponent {
                ...
                <MyScrollViewComponent
                    ...
                    <View style={StyleUtil.gStyles.gCardBgWhite}>
                        <List>
                            ...
                            <MyLabelTextComponent _label={'Lecture'} _labelContent={item.lecture_name}/>
                            <MyLabelTextComponent _label={'Lecturer'} _labelContent={item.username}/>
                            <MyLabelTextComponent _label={'Room'} _labelContent={item.room}/>
                            <MyLabelTextComponent _label={'Time'} _labelContent={DateparseFormatUtil.formatDateLongOrStringToStringMinuteLong10(item.schooltime)}/>
                            <MyLabelTextComponent _label={'Start Time'} _labelContent={DateparseFormatUtil.formatDateLongOrStringToStringMinuteLong10(item.start_sign_time)}/>
                            <MyLabelTextComponent _label={'End Time'} _labelContent={DateparseFormatUtil.formatDateLongOrStringToStringMinuteLong10(item.end_sign_time)}/>
                            <MyLabelTextComponent _label={'Description'} _labelContent={item.lecture_introduction}/>

                            <List.Item>

                                <LabelWithInputSingleLineNormalNoBorderComponent _labelContent={'Verify Code    '}
    ...
    checkInfo() {
        ...
        if (TmpDataUtil.curLongitude == '') {
            ViewUtil.showToast('Fail to get Location');
            return false;
        }
        return true;
    }
