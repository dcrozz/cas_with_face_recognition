...
export default class PublicCoursePage extends BaseComponent {
    ...
    checkInfo() {
        if (!this.state.curCourse.id) {
            ViewUtil.showToast('Please Select Lecture');
            return false;
        }
        if (this.state.address == '' || StringUtil.trim(this.state.address).length == 0) {
            ViewUtil.showToast('Please Input Room');
            return false;
        }
    ...
    componentWillMount() {
        ...
        this.action = {
            ...
            "title" : "Date+Time",                         // 显示的标题
            "subTitle" : "Please Select",                    // 显示的副标题，非必须
            ...
            "validator" : [
                {
                    "rule" : "range",
                    "value" : "6,30",
                    "error" : "Password should be between 6 to 30"
                }
            ]
        };
        this.action1 = {
                    ...
                    <MyViewComponent
                        ...
                        <List>
                            ...
                            <List.Item>
                                ...
                                <LabelWithInputSingleLineNormalNoBorder _labelContent={'Room'}
